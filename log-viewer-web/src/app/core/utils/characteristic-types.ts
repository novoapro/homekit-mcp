 ...
 * Ported from HomeKitMCP/Utilities/CharacteristicTypes.swift
 *
 * UUID values are Apple's standard HMCharacteristicType constants.
 */
...
export function characteristicDisplayName(type: string): string {
  ...
  // Non-UUID string (e.g. "Target-Heating-Cooling.Current") — clean up
...
export function formatCharacteristicValue(value: any, characteristicType: string): string {
